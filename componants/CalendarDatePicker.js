...
export default class CalendarDatePicker {
      ...
      <div class="${CDP.classNames.body}">
        ...
        <div class="${CDP.classNames.header}">
          <div class="${CDP.classNames.yearSelect}">
            <button class="${CDP.classNames.decrementYear}"><div class="${CDP.classNames.btnTriangleLeft}"></div></button>
            <p class="${CDP.classNames.yearValue}"></p>
            <button class="${CDP.classNames.incrementYear}"><div class="${CDP.classNames.btnTriangleRight}"></div></button>
          </div>
          <div class="${CDP.classNames.monthSelect}">
            <button class="${CDP.classNames.previousMonth}"><div class="${CDP.classNames.btnTriangleLeft}"></div></button>
  ...
  buildCalendarDatePicker(year, month) {
    ...
    this.addGreyoutClassToPreviousAndNextMonthDays();
